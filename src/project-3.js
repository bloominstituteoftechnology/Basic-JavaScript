...
const addProperty = (object, property) => {
  ...
  object[property] = null; // Sets the value to null of 'property' to null.  Why does this not return the object WITH the additional property when I run it.
  return object;
};
...
const multiplyMysteryNumberByFive = (mysteryNumberObject) => {
  ...
  const prod = mysteryNumberObject.mysteryNumber * 5;
  return prod;
};
