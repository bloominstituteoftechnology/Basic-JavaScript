...
const makeCat = (name, age) => ({ name, age, meow: () => 'Meow!' });
// create a new object with a name property with the value set to the name argument
// add an age property to the object with the value set to the age argument
// add a method called meow that returns the string 'Meow!'
// return the object

const addProperty = (object, property) => Object.assign({ [property]: null }, object);
...
const newUser = (name, email, password) => ({ name, email, password });
...
const setUsersToPremium = users => users.map((user) => {
  user.isPremium = true;
  return user;
});
